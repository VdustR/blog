---
title: "addEventListener() useCapture"
publishDate: 2022-03-14
description: 稍微記錄一下 addEventListener useCapture 的效果。
image: https://vdustr.github.io/asset-2022/03-14-add-event-listener-use-capture/og.png
authors: [ViPro]
tags:
  - event
  - addEventListener
...
![addEventListener() useCapture](https://vdustr.github.io/asset-2022/03-14-add-event-listener-use-capture/og.png)
...
Reference: [https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener#usecapture](https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener#usecapture)
